...
-- Forward-declare so closures below can capture it
local KeyGate
    ...
    if saved then
        task.spawn(function()
            ...
            if trimmed ~= "" and verifyKey(trimmed) then
                ...
                -- saved key invalid/expired — delete file
...
SubT.BackgroundTransparency = 1; SubT.Text = "Server Finder"
